...
template <class T>
struct _Has_GetMiscStatus<T, ::std::void_t<::std::enable_if_t<::std::is_same_v<int, decltype(::std::declval<T>()._GetMiscStatus())>>>> : ::std::true_type{};

template <class T, class = void>
struct _Has_FinalConstruct : ::std::false_type{};
template <class T>
struct _Has_FinalConstruct<T, ::std::void_t<::std::enable_if_t<::std::is_same_v<void, decltype(::std::declval<T>().FinalConstruct())>>>> : ::std::true_type{};

template <class T, class = void>
struct _Has_InternalFinalConstructAddRef : ::std::false_type{};
template <class T>
struct _Has_InternalFinalConstructAddRef<T, ::std::void_t<::std::enable_if_t<::std::is_same_v<void, decltype(::std::declval<T>().InternalFinalConstructAddRef())>>>> : ::std::true_type{};

template <class T, class = void>
struct _Has_InternalFinalConstructRelease : ::std::false_type{};
template <class T>
struct _Has_InternalFinalConstructRelease<T, ::std::void_t<::std::enable_if_t<::std::is_same_v<void, decltype(::std::declval<T>().InternalFinalConstructRelease())>>>> : ::std::true_type{};

template <class T, class = void>
struct _Has_FinalRelease : ::std::false_type{};
template <class T>
struct _Has_FinalRelease<T, ::std::void_t<::std::enable_if_t<::std::is_same_v<void, decltype(::std::declval<T>().FinalRelease())>>>> : ::std::true_type{};
...
#define DECLARE_REGISTRY_RESOURCE_V2_WITH_MODULE(x, className)\
	...
	{\
		...
		{ \
			...
			TCHAR szOleMisc[32]; \
			ATL::Checked::itot_s(static_cast<_Ty&>(*this)._GetMiscStatus(), szOleMisc, _countof(szOleMisc), 10); \
			USES_CONVERSION_EX; \
