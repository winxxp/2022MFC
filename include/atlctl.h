...
template <class T>
struct _Has_OnFontChanged<T, ::std::void_t<::std::enable_if_t<::std::is_same_v<int, decltype(::std::declval<T>().OnFontChanged())>>>> : ::std::true_type{};
...
template <class T>
struct _Has_OnPictureChanged<T, ::std::void_t<::std::enable_if_t<::std::is_same_v<int, decltype(::std::declval<T>().OnPictureChanged())>>>> : ::std::true_type{};
...
template <class T>
struct _Has_OnMouseIconChanged<T, ::std::void_t<::std::enable_if_t<::std::is_same_v<int, decltype(::std::declval<T>().OnMouseIconChanged())>>>> : ::std::true_type{};
...
#define IMPLEMENT_STOCKPROP(type, fname, pname, dispid) \
	...
	template <class _Ty> \
	struct _Has_On##fname##Changed<_Ty, ::std::void_t<::std::enable_if_t<::std::is_same_v<int, decltype(::std::declval<_Ty>().On##fname##Changed())>>>> : ::std::true_type{}; \
